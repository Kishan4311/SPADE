...
INPUT_PATH = Path("/home/iitb/Kishan_SpecDec/results_cnnDailyMail/cnnDailyMail_result_gm10_tgt8B_genLen128.json")
OUTPUT_PATH = Path("/home/iitb/Kishan_SpecDec/summary_cnnDailyMail/summary_gm10_tgt8B_genLen128.json")
...
def compute_cider_scores_list(refs_list: List[List[str]], hyps: List[str]) -> List[float]:
    ...
    return [float(s)*100.0 for s in scores]
